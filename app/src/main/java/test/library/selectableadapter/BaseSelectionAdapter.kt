package test.library.selectableadapter

import android.util.SparseBooleanArray
import androidx.core.util.keyIterator
import androidx.recyclerview.widget.RecyclerView
import test.library.selectableadapter.callback.OnCheckBoxSelectionListener
import test.library.selectableadapter.callback.OnSelectionListener
import test.library.selectableadapter.viewholder.BaseSelectableViewHolder
...
//            idsSelectedItems.remove(position)
    ...
    fun setSelectedElement(position: Int, checked: Boolean) {
        selectedItems.put(position, checked)
        updateSelectionListener(position, checked)
    }
